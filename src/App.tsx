...
function App() {
  ...
  return (
    <div className="App">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 160 1440 120" style={{ marginTop: '-1rem' }}><path fill="#AB47BC" fillOpacity="1" d="M0,160L120,176C240,192,480,224,720,229.3C960,235,1200,213,1320,202.7L1440,192L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
    </div>
  );
}
